...
export const POST = withValidateFieldHandler(null, null, PostAccountLoginBodyDTO, async (request: NextRequest, ctx: THofContext<never, never, typeof PostAccountLoginBodyDTO>) => {
