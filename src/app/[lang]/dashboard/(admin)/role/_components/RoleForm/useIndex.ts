...
export type Inputs = Pick<Role, 'name' | 'description'> & { permissionIds: string[] }
...
export default () => {
    ...
    const tableData = useMemo(() => {
        const res: { [key in EPermissionResource]?: { [key2 in EPermissionAction]?: string } } = {}
