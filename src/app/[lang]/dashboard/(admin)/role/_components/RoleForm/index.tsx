...
import { Checkbox, CircularProgress, Table, TableBody, TableCell, TableHead, TableRow } from "@mui/material";
...
type TProps = {
    ...
    handleChangeCheckbox: (id: string) => (event: React.ChangeEvent<HTMLInputElement>, checked: boolean) => void
}
