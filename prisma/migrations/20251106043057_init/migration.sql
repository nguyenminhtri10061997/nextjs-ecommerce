...
-- CreateTable
CREATE TABLE "ProductOptionToOptionItem" (
    "id" TEXT NOT NULL,
    ...
    CONSTRAINT "ProductOptionToOptionItem_pkey" PRIMARY KEY ("id")
);
...
-- CreateIndex
CREATE UNIQUE INDEX "ProductOptionToOptionItem_productOptionId_optionItemId_key" ON "ProductOptionToOptionItem"("productOptionId", "optionItemId");
...
-- AddForeignKey
ALTER TABLE "ProductOptionToOptionItem" ADD CONSTRAINT "ProductOptionToOptionItem_optionItemId_fkey" FOREIGN KEY ("optionItemId") REFERENCES "OptionItem"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "ProductOptionToOptionItem" ADD CONSTRAINT "ProductOptionToOptionItem_productOptionId_fkey" FOREIGN KEY ("productOptionId") REFERENCES "ProductOption"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
